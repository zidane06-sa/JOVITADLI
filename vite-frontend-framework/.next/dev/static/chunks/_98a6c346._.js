...
function WaitingPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WaitingPage.useEffect": ()=>{
            const pollIRStatus = {
                "WaitingPage.useEffect.pollIRStatus": async ()=>{
                    try {
                        ...
                        if (data.success && data.irStatus) {
                            ...
                            if (lastIRState !== null && lastIRState !== irDetected && irDetected) {
                                ...
                                setCurrentCount({
                                    "WaitingPage.useEffect.pollIRStatus": (prev)=>{
                                        const newCount = prev + 1;
                                        console.log(`IR Detected! Count: ${newCount}`);
                                        return newCount;
                                    }
                                }["WaitingPage.useEffect.pollIRStatus"]);
                            }
...
_s(WaitingPage, "y2kkD/W3mcr4DJmkaozOP9cNOIQ=", false, function() {
    return [
...
//# sourceMappingURL=_98a6c346._.js.map